...
public class NarayanAdmob {
    private static final String TAG = "NarayanAdmob";
    private static NarayanAdmob instance;
...
//    private AppOpenAd appOpenAd = null;
    ...
    public static NarayanAdmob getInstance() {
        if (instance == null) {
            instance = new NarayanAdmob();
            instance.isShowLoadingSplash = false;
        }
        return instance;
    }

    private NarayanAdmob() {
...
//            return;
        ...
        new Handler(activity.getMainLooper()).postDelayed(new Runnable() {
            ...
            public void run() {
                if (interstitialSplashLoaded() && !isShowLoadingSplash()) {
                    ...
                    NarayanAdmob.getInstance().onShowSplash(activity, callback);
                }
            }
        }, timeDelay);
    }
    ...
    public void loadInterstitialAds(Context context, String id, long timeOut, AdCallback adListener) {
        ...
        getInterstitialAds(context, id, new AdCallback() {
            @Override
            public void onInterstitialLoad(InterstitialAd interstitialAd) {
                NarayanAdmob.this.interstitialAd = interstitialAd;
...
//
    ...
    public void initRewardAds(Context context, String id) {
        ...
        RewardedAd.load(context, id, getAdRequest(), new RewardedAdLoadCallback() {
            ...
            public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                NarayanAdmob.this.rewardedAd = rewardedAd;
                NarayanAdmob.this.rewardedAd.setOnPaidEventListener(adValue -> {

                    Log.d(TAG, "OnPaidEvent Reward:" + adValue.getValueMicros());

                    NarayanLogEventManager.logPaidAdImpression(context,
                            adValue,
                            rewardedAd.getAdUnitId(), NarayanAdmob.this.rewardedAd.getResponseInfo().getMediationAdapterClassName()
                            , AdType.REWARDED);
                });
            }
    ...
    public void initRewardAds(Context context, String id, AdCallback callback) {
        ...
        RewardedAd.load(context, id, getAdRequest(), new RewardedAdLoadCallback() {
            ...
            public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                ...
                NarayanAdmob.this.rewardedAd.setOnPaidEventListener(adValue -> {
                    ...
                    NarayanLogEventManager.logPaidAdImpression(context,
                            ...
                            NarayanAdmob.this.rewardedAd.getResponseInfo().getMediationAdapterClassName()
                            , AdType.REWARDED);
                });
            ...
            public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                ...
                NarayanAdmob.this.rewardedAd = null;
                Log.e(TAG, "RewardedAd onAdFailedToLoad: " + loadAdError.getMessage());
            }
        });
    }
    ...
    public void showRewardAds(final Activity context, final RewardCallback adCallback) {
        ...
        if (rewardedAd == null) {
            ...
            NarayanAdmob.this.rewardedAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent();
                    if (adCallback != null)
