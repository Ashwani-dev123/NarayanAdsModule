...
public class NarayanNativeAdView extends RelativeLayout {
    ...
    public void populateNativeAdView(Activity activity, AppNativeAd nativeAd){
        if(layoutLoading == null){
    ...
    public void loadNativeAd(Activity activity, String idAd) {
        ...
        NarayanAd.getInstance().loadNativeAd(activity, idAd, layoutCustomNativeAd, layoutPlaceHolder, layoutLoading);
    }
