...
public class AppAdError {
    ...
    public AppAdError(AdError adError) {
        this.adError = adError;
    }

    public AppAdError(LoadAdError loadAdError) {
        this.loadAdError = loadAdError;
    }

    public AppAdError(MaxError maxError) {
        this.maxError = maxError;
    }

    public AppAdError(String message) {
